...
(вернее поднять флаг true) если возраст, курс или средняя оценка, ВЫШЕ или равны заданной, ну и пол
соответствует выбранному.
*/
class CheckStudentOtherAgeOrAvgGradeOrSexOrCourse implements CheckStudent {
    @Override
